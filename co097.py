...
SUPER_ADMIN_LINK = "https://t.me/black_devil_tools"
SUPER_ADMINS = [1029883095]

BOT_TOKEN = "8148954759:AAGVYFfONGd_hrF5zTOanNFc7JCf1G3P-ls"
LOG_CHANNEL_ID = -1004420827783

_DATA_FILE = "blasgggt_data.json"
_VERSION = "v2-PREMIUM"
...
async def user_home(cq: CallbackQuery, state: FSMContext):
    ...
    if is_admin(uid, d):
        ...
        return
    if not can_use(uid, d):
        await cq.message.edit_text(f"{em(EMOJI_CROSS, '⛔')} Access nahi hai!\n\nContact: {SUPER_ADMIN_NAME}", parse_mode="HTML")
        return
